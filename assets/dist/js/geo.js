...
// var form = document.querySelector('#dojo-place');
//
// form.addListener('focus', function( event ) {
//   event.target.style.background = 'pink';
// }, true);
//
// form.addListener('blur', function( event ) {
...
var addr = _toConsumableArray(addressInputs);

var zoom = 12;
var map, initialLocation, marker;
addr.forEach(function (addressInput) {
...
function initMap() {
  ...
  if (placeLat.value === '0' && placeLng.value === '0') {
    if (!address) {
      ...
      map.setCenter(initialLocation); // zoom = 1;
    } else {
      // alert('have address')
      geocodeAddress(geocoder, map); // geocode address
      // prompt to save
    }
  } else {
    ...
    console.log(markerLL); // alert(placeLat.value+' & '+placeLng.value);
    // add marker
    ...
    marker.addListener('dragend', handleEventDragEnd); // // geocodeAddress(geocoder, map);
  } // })
...
/***/ 5:
/*!*****************************************!*\
  !*** multi ./assets/src/scripts/geo.js ***!
  \*****************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! /home/d/sites/bka01/wp-content/themes/bka2020/assets/src/scripts/geo.js */"./assets/src/scripts/geo.js");
